...
import TimeFilter from '#/features/optimizer/presentations/components/TimeFilter'
import StatCard from '#/features/optimizer/presentations/components/StatCard'
import SpendingChart from '#/features/optimizer/presentations/components/SpendingChart'
import CategoryBars from '#/features/optimizer/presentations/components/CategoryBars'
import TransactionList from '#/features/optimizer/presentations/components/TransactionList'
import { useOptimizerData } from '#/features/optimizer/hooks/useOptimizerData'
...
function OptimizerPage() {
  const { data, isLoading } = useOptimizerData()
