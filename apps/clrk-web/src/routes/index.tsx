      ...
      <div className="flex gap-0.5">
        {Array.from({ length: 12 }).map((_, i) => (
          <span
            ...
            style={{ background: color, opacity: i < filled ? 1 : 0.1 }}
          />
        ))}
      </div>
    </div>
    ...
    <div className="landing-bg min-h-screen">
      ...
      <section className="flex min-h-screen flex-col items-center justify-center px-6 pb-16 pt-24">
        <div className="mx-auto max-w-4xl text-center">
          <div className="animate-in fade-in duration-500 fill-mode-both" style={{ animationDelay: '100ms' }}>
            <Badge
              variant="secondary"
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div className="reveal">
              <Badge variant="secondary" className="gap-1.5 font-mono text-[10px] uppercase tracking-widest">
              ...
              <GlassCard variant="elevated" className="p-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {HERO_STATS.slice(0, 4).map((s) => (
                    <div key={s.label} className="rounded-lg bg-accent/50 p-3">
                      <p className="font-mono text-[9px] uppercase tracking-widest text-muted-foreground">
                        {s.label}
                      </p>
                ...
                <div className="space-y-3">
                  {MOCK_CATEGORIES.map((c) => (
                    <MiniCategoryBar key={c.category} {...c} />
                  ))}
                </div>
              </GlassCard>
            </div>
              ...
              <GlassCard variant="elevated" className="p-5">
                ...
                <div className="mt-4 space-y-3">
                  {[
                    ...
                    <div key={f.label} className="flex items-baseline justify-between border-b border-border pb-2">
              ...
              <GlassCard variant="elevated" className="p-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="flex flex-col items-center rounded-xl border border-border p-4 text-center">
                    ...
                    <p className="mt-0.5 font-mono text-xl font-bold text-muted-foreground">30%</p>
                  </div>
                </div>
                <Separator className="my-4" />
